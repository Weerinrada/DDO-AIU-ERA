...
1. Analysis of financial statements and the company's financial situation. If it's a listed company, analyze from {fin_data}. If not a listed company in the stock market DO NOT Show any Data and explain why:
    - Show the values of Total revenue, Total Assets, Total Liabilities Net Minority Interest, Total Equity Gross Minority Interest, and Net Income From Continuing Operation for the past 3 years ถ้ามีไม่ครบ 3 ปี ใช้เท่าที่มีนับจากปีปัจจุบัน (Must be provided data in table format only)
